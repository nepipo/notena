...
/**
 * Liefert das heutige Briefing (aus Cache oder frisch generiert).
 * Gibt null zurück, wenn die Karte nicht gezeigt werden soll
 * (kein Pro, deaktiviert, nicht eingeloggt, API-Fehler).
 */
export async function holeBriefing(): Promise<string | null> {
  ...
  try {
    ...
    // Karte still ausblenden statt das Dashboard crashen zu lassen.
